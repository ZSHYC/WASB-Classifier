...
python label_patches.py --manifest patch_outputs/patches_train5/manifest.csv --size 512

从第100张开始标注：
python label_patches.py --manifest patch_outputs/patches_train5/manifest.csv --size 512 --start-from 100
"""
